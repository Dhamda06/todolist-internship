...
<head>
    ...
    <style>
        ...
        .login-container { max-width: 450px; padding: 2.5rem; border-radius: 1.5rem; background-color: #ffffff; box-shadow: 0 10px 30px rgba(0,0,0,0.1); }
        h2 { text-align: center; font-weight: 700; color: #6B8E23; margin-bottom: 2rem; }
        .form-control { border-radius: 0.75rem; }
        .btn-login { background-color: #6B8E23; border-color: #6B8E23; color: white; font-weight: 600; }
        .btn-login:hover { background-color: #556B2F; border-color: #556B2F; }
...
<body>
    <div class="login-container">
        ...
        <p class="text-center mt-3">Belum punya akun? <a href="<?= site_url('todo/register') ?>">Daftar sekarang</a></p>
    </div>
</body>
</html>